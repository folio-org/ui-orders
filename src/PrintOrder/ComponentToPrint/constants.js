...
export const LINE_FIELDS_MAP = {
  ...
  productIds: 'details.productIds.productId',
  productIdTypes: 'details.productIds.productIdType',
  qualifiers: 'details.productIds.qualifiers',
  materialTypePhysical: 'physical.materialType',
...
export const LINE_FIELDS_LABELS = {
  ...
  [LINE_FIELDS_MAP.productIdTypes]: <FormattedMessage id="ui-orders.itemDetails.productIdType" />,
  [LINE_FIELDS_MAP.qualifiers]: <FormattedMessage id="ui-orders.itemDetails.qualifier" />,
  [LINE_FIELDS_MAP.materialTypePhysical]: <FormattedMessage id="ui-orders.poLine.materialType" />,
